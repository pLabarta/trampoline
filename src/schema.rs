...
use ckb_types::core::cell::{CellMeta, SystemCellMap, ResolvedTransaction, ResolvedDep};
use ckb_types::{prelude::*, packed::{CellDep, TransactionView, TransactionInfo}};
use ckb_types::bytes::Bytes;
use anyhow::Result;
use std::path::Path;
use crate::project::TrampolineProject;
use crate::{TrampolineResourceType, TrampolineResource};
use thiserror::Error;
...
impl TrampolineResource for Schema {
    ...
    fn init(args: Self::InitArgs) -> Result<TrampolineResourceType, Self::Error> {
        ...
        if gen_bindings_flag {
            println!("Generating Rust bindings for schema at {}/{}.rs\n",
